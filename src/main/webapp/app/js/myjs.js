...
function ajaxsubmitaddjobrecord() {
    $.ajax({
            ...
            type:"POST",
            //提交的网址
            url:"rest/page/addjobrecord",
            //提交的数据
            data: {
                jobid: $("#form_job_id_unchanged").val(),
                optype: $("#form_job_optype").val(),
                opContent: $("#form_job_operate_content").val(),
                optime: $("#form_job_operatetime").val()
            },
            //返回数据的格式
            datatype: "html",
            //在请求之前调用的函数
